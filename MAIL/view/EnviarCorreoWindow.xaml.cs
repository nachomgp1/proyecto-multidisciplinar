...
namespace MAIL.view
{
    public partial class EnviarCorreoWindow : Window
    {
        ...
        private ObservableCollection<ArchivoAdjunto> archivosAdjuntos;
        ...
        public EnviarCorreoWindow(GmailService service)
        {
            ...
            archivosAdjuntos = new ObservableCollection<ArchivoAdjunto>();
        ...
        private void AgregarArchivo(string rutaArchivo)
        {
            ...
            archivosAdjuntos.Add(new ArchivoAdjunto
            {
        ...
        {
            var archivoAEliminar = (sender as FrameworkElement)?.DataContext as ArchivoAdjunto;
